...
/* Used only for internal RNDV functions */
...
ucp_proto_rndv_rts_request_init(ucp_request_t *req)
{
    ...
    /* Should not fail when UCT_MD_MEM_FLAG_HIDE_ERRORS is used */
                                ...
                                const ucp_proto_multi_lane_priv_t *lpriv)
{
    ...
    size_t offset = req->send.rndv.offset + req->send.state.dt_iter.offset;
